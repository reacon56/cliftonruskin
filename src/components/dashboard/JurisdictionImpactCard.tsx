...
export default function JurisdictionImpactCard() {
  ...
  const [selectedGroup, setSelectedGroup] = useState<ImpactGroup | null>(null);
  ...
  const loadImpacts = async () => {
    ...
    // Get recent impacts for this org with alert event details
  ...
  return (
    <div
      className="fvc-card animate-fade-in"
      style={{ animationDelay: "400ms", animationFillMode: "both" }}
    >
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          <Globe size={16} className="text-accent" />
          <h2 className="fvc-heading-3 text-foreground">Jurisdiction Changes Affecting You</h2>
        </div>
        {totalImpacted > 0 && (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="text-[10px] text-muted-foreground shrink-0">
                      {new Date(g.detectedAt).toLocaleDateString("en-GB", {
                        day: "numeric",
                        month: "short",
                      })}
                    </div>
              ...
              <DialogContent className="max-w-lg">
                <DialogHeader>
                  <DialogTitle className="flex items-center gap-2 text-base">
                    ...
                    {g.jurisdictionName} — Impact Detail
                  </DialogTitle>
                </DialogHeader>
